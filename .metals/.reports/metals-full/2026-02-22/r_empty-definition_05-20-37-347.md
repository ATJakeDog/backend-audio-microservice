error id: file:///C:/GANTone/backend/src/main/java/com/example/GANTone/GANToneApplication.java:_empty_/GeneratedValue#strategy#
...
@Table(name = "tasks")
class Task {
    @Id @GeneratedValue(strateg@@y = GenerationType.IDENTITY)
    public Long id;
